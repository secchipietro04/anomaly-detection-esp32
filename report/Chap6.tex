...
\begin{table}[H]
	...
	\begin{tabular}{lccc}
		...
		& \multicolumn{3}{c}{\small (F1-Score: Senza Memoria / Con Memoria)} \\
		\midrule
		Dense AE            & 0.531 / 0.534 & 0.508 / 0.528 & 0.530 / 0.538 \\
		Variazionale AE     & \textbf{0.536} / 0.535 & 0.516 / \textbf{0.544} & \textbf{0.536} / \textbf{0.540} \\
		Conv 1D AE          & 0.493 / 0.487 & 0.462 / 0.499 & 0.471 / 0.508 \\
		Conv 2D AE          & 0.528 / 0.531 & \textbf{0.519} / 0.530 & 0.529 / 0.534 \\
		ConvLSTM            & 0.451 / 0.443 & 0.416 / 0.459 & 0.425 / 0.458 \\
		Ensemble Eterogeneo & 0.526 / \textbf{0.534} & 0.503 / 0.535 & 0.524 / 0.529 \\
		\bottomrule
	\end{tabular}
	\caption{F1-Score medio nelle lavorazioni CNC in cui la memoria temporale migliora le prestazioni complessive (13 lavorazioni su 30, 43.3\% del totale).}
