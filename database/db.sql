CREATE TABLE
  IF NOT EXISTS "sensor" ("id" INT PRIMARY KEY, "settings" VARCHAR(1024));

CREATE TABLE
  IF NOT EXISTS "datapoint_schema" (
...
ALTER TABLE "result" ADD FOREIGN KEY ("datapoint_id") REFERENCES "datapoint" ("id") ON DELETE SET NULL DEFERRABLE INITIALLY IMMEDIATE;